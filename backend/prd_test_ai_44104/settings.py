"""
Django settings for prd_test_ai_44104 project.
...
ROOT_URLCONF = 'prd_test_ai_44104.urls'
...
WSGI_APPLICATION = 'prd_test_ai_44104.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_test_ai_44104 API",
    "DESCRIPTION": "API documentation for prd_test_ai_44104 App",
    "VERSION": "v1",
}
